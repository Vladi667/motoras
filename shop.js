...
window.MotorasHome = (() => {
  ...
  function renderFeaturedProducts() {
    ...
    if (!products.length) { grid.innerHTML = '<div style="grid-column:1/-1;padding:24px;border:1px dashed #ddd;border-radius:16px;text-align:center;color:#666">Catalogul este temporar indisponibil.</div>'; return; }

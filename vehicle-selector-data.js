(function () {
 if (window.MotorasVehicleData) return;
 const MODELS = {
 ...
 'Dacia':['1300','Duster','Jogger','Logan','Logan MCV','Nova','Pick-Up','Sandero','Spring','Solenza','SuperNova','Lodgy','Dokker'],
 ...
 'Ford':['B-Max','C-Max','EcoSport','Edge','Escape','Explorer','Fiesta','Focus','Fusion','Galaxy','Grand C-Max','Ka','Ka+','Kuga','Maverick','Mondeo','Mustang','Puma','Ranger','S-Max','Tourneo','Transit','Transit Connect','Transit Custom'],
 'Honda':['Accord','Civic','CR-V','CR-Z','FR-V','HR-V','Insight','Jazz','Legend','Logo','NSX','Pilot','Prelude','Stream','Type R'],
 'Hyundai':['Bayon','Elantra','Getz','Grand Santa Fe','i10','i20','i30','i40','i800','Ioniq','Ioniq 5','Ioniq 6','ix20','ix35','ix55','Kona','Santa Fe','Sonata','Staria','Terracan','Trajet','Tucson'],
 ...
 'Mercedes-Benz':['Clasa A','Clasa B','Clasa C','Clasa CLA','Clasa CLS','Clasa E','Clasa G','Clasa GL','Clasa GLA','Clasa GLB','Clasa GLC','Clasa GLE','Clasa GLS','Clasa M','Clasa R','Clasa S','Clasa SL','Clasa SLC','Clasa SLK','Clasa V','Clasa X','AMG GT','EQA','EQB','EQC','EQE','EQS','Marco Polo','Sprinter','Viano','Vito'],
 'MG':['3','4','5','6','EHS','HS','Marvel R','RX5','ZS'],
 'Mini':['Cabrio','Clubman','Clubvan','Cooper','Cooper S','Countryman','Coupe','Hatch','One','Paceman','Roadster'],
 'Mitsubishi':['ASX','Colt','Eclipse Cross','Galant','Grandis','L200','Lancer','Outlander','Pajero','Pajero Sport','Space Star'],
 'Nissan':['350Z','370Z','Almera','Ariya','Evalia','Juke','Leaf','Micra','Murano','Navara','Note','NV200','NV400','Pathfinder','Patrol','Primastar','Primera','Pulsar','Qashqai','Tiida','Townstar','X-Trail','e-NV200'],
 ...
 'Peugeot':['1007','107','108','2008','206','207','208','3008','301','306','307','308','4007','4008','408','5008','508','607','806','807','Bipper','Boxer','Expert','Ion','Partner','RCZ','Rifter','Traveller'],
 'Porsche':['718 Boxster','718 Cayman','911','Cayenne','Macan','Panamera','Taycan'],
 'Renault':['Arkana','Austral','Captur','Clio','Espace','Express','Fluence','Grand Scenic','Kadjar','Kangoo','Koleos','Laguna','Latitude','Master','Megane','Modus','Safrane','Scenic','Symbol','Trafic','Twizy','Vel Satis','Wind','Zoe'],
 'Rolls-Royce':['Cullinan','Dawn','Ghost','Phantom','Silver Shadow','Silver Spirit','Spectre','Wraith'],
 ...
 'Toyota':['Auris','Avensis','Aygo','Aygo X','C-HR','Camry','Corolla','GR Yaris','GR86','Hilux','Land Cruiser','Mirai','Previa','Prius','ProAce','ProAce City','RAV4','Supra','Urban Cruiser','Verso','Yaris','Yaris Cross','bZ4X'],
